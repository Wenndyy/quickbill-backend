        ...
        <section class="section">
            ...
            <div class="section-header"
                ...
                <div style="display: flex; flex-direction: column; justify-content: center;">
                    <h1 style="margin: 0; padding: 0; font-size: 32px; font-weight: bold; color: #333;">Categories</h1>
                    <p style="margin: 0; padding: 0; color: #888; font-size: 14px;">You can manage all Categories, such as
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 style="color: #48A6A7; margin: 0;">All Categories</h4>
                                <form method="GET" action="{{ route('categories.index') }}" class="mb-0">
                                    <div style="display: flex; align-items: center; background: #fff; border-radius: 999px; padding: 8px 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); max-width: 300px;">
                                        <button
